...
forge script scripts/05-MorpherStaking.s.sol "$@"
forge script scripts/06-MorpherMintingLimiter.s.sol "$@"
forge script scripts/07-MorpherTradeEngine.s.sol "$@"
forge script scripts/08-MorpherOracle.s.sol "$@"
