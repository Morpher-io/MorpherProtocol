...
import "./MorpherAntiMEV.sol";

contract MorpherToken is ERC20Upgradeable, MorpherAntiMEVUpgradeable, ERC20PausableUpgradeable {
	...
	function _beforeTokenTransfer(
		...
		address to,
		uint256 amount
	) internal virtual override(ERC20Upgradeable, MorpherAntiMEVUpgradeable, ERC20PausableUpgradeable) {
		require(
			!_restrictTransfers ||
