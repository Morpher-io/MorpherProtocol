...
contract('MorpherTradeEngine', (accounts) => {
    ...
    it('test case 1: open long, 300 MPH, each share 150MPH = 2 Shares', async () => {
        ...
        let orderId = (await morpherOracle.createOrder(BTC, 0, roundToInteger(300), true, 100000000, 0 ,0 ,0 ,0, { from: account1 })).logs[0].args._orderId;
...
//         //(_marketId, _closeSharesAmount, _openMPHAmount, _tradeDirection, _orderLeverage, _onlyIfPriceAbove, _onlyIfPriceBelow, _goodUntil, _goodFrom)
//         let orderId = (await morpherOracle.createOrder(BTC, 0, roundToInteger(160), false, 100000000, 0 ,0 ,0 ,0, { from: account1, value: 301000000000000 })).logs[0].args._orderId;
...
//         //(_marketId, _closeSharesAmount, _openMPHAmount, _tradeDirection, _orderLeverage, _onlyIfPriceAbove, _onlyIfPriceBelow, _goodUntil, _goodFrom)
//         let orderId = (await morpherOracle.createOrder(BTC, 0, roundToInteger(150), true, 100000000, 0 ,0 ,0 ,0, { from: account1, value: 301000000000000 })).logs[0].args._orderId;
